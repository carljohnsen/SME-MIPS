...
namespace Adder32 {
	...
	public class AdderTester : Process
	{
		...
		{
			inputa0.Bit = (num1 >> 0) & 1;
			inputb0.Bit = (num2 >> 0) & 1;
			inputa1.Bit = (num1 >> 1) & 1;
			inputb1.Bit = (num2 >> 1) & 1;
			inputa2.Bit = (num1 >> 2) & 1;
			inputb2.Bit = (num2 >> 2) & 1;
			inputa3.Bit = (num1 >> 3) & 1;
			inputb3.Bit = (num2 >> 3) & 1;
			inputa4.Bit = (num1 >> 4) & 1;
			inputb4.Bit = (num2 >> 4) & 1;
			inputa5.Bit = (num1 >> 5) & 1;
			inputb5.Bit = (num2 >> 5) & 1;
			inputa6.Bit = (num1 >> 6) & 1;
			inputb6.Bit = (num2 >> 6) & 1;
			inputa7.Bit = (num1 >> 7) & 1;
			inputb7.Bit = (num2 >> 7) & 1;
			inputa8.Bit = (num1 >> 8) & 1;
			inputb8.Bit = (num2 >> 8) & 1;
			inputa9.Bit = (num1 >> 9) & 1;
			inputb9.Bit = (num2 >> 9) & 1;
			inputa10.Bit = (num1 >> 10) & 1;
			inputb10.Bit = (num2 >> 10) & 1;
			inputa11.Bit = (num1 >> 11) & 1;
			inputb11.Bit = (num2 >> 11) & 1;
			inputa12.Bit = (num1 >> 12) & 1;
			inputb12.Bit = (num2 >> 12) & 1;
			inputa13.Bit = (num1 >> 13) & 1;
			inputb13.Bit = (num2 >> 13) & 1;
			inputa14.Bit = (num1 >> 14) & 1;
			inputb14.Bit = (num2 >> 14) & 1;
			inputa15.Bit = (num1 >> 15) & 1;
			inputb15.Bit = (num2 >> 15) & 1;
			inputa16.Bit = (num1 >> 16) & 1;
			inputb16.Bit = (num2 >> 16) & 1;
			inputa17.Bit = (num1 >> 17) & 1;
			inputb17.Bit = (num2 >> 17) & 1;
			inputa18.Bit = (num1 >> 18) & 1;
			inputb18.Bit = (num2 >> 18) & 1;
			inputa19.Bit = (num1 >> 19) & 1;
			inputb19.Bit = (num2 >> 19) & 1;
			inputa20.Bit = (num1 >> 20) & 1;
			inputb20.Bit = (num2 >> 20) & 1;
			inputa21.Bit = (num1 >> 21) & 1;
			inputb21.Bit = (num2 >> 21) & 1;
			inputa22.Bit = (num1 >> 22) & 1;
			inputb22.Bit = (num2 >> 22) & 1;
			inputa23.Bit = (num1 >> 23) & 1;
			inputb23.Bit = (num2 >> 23) & 1;
			inputa24.Bit = (num1 >> 24) & 1;
			inputb24.Bit = (num2 >> 24) & 1;
			inputa25.Bit = (num1 >> 25) & 1;
			inputb25.Bit = (num2 >> 25) & 1;
			inputa26.Bit = (num1 >> 26) & 1;
			inputb26.Bit = (num2 >> 26) & 1;
			inputa27.Bit = (num1 >> 27) & 1;
			inputb27.Bit = (num2 >> 27) & 1;
			inputa28.Bit = (num1 >> 28) & 1;
			inputb28.Bit = (num2 >> 28) & 1;
			inputa29.Bit = (num1 >> 29) & 1;
			inputb29.Bit = (num2 >> 29) & 1;
			inputa30.Bit = (num1 >> 30) & 1;
			inputb30.Bit = (num2 >> 30) & 1;
			inputa31.Bit = (num1 >> 31) & 1;
			inputb31.Bit = (num2 >> 31) & 1;
		}

		public int GetOutput()
		{
			int result = 0;
			result |= output0.Bit << 0;
			result |= output1.Bit << 1;
			result |= output2.Bit << 2;
			result |= output3.Bit << 3;
			result |= output4.Bit << 4;
			result |= output5.Bit << 5;
			result |= output6.Bit << 6;
			result |= output7.Bit << 7;
			result |= output8.Bit << 8;
			result |= output9.Bit << 9;
			result |= output10.Bit << 10;
			result |= output11.Bit << 11;
			result |= output12.Bit << 12;
			result |= output13.Bit << 13;
			result |= output14.Bit << 14;
			result |= output15.Bit << 15;
			result |= output16.Bit << 16;
			result |= output17.Bit << 17;
			result |= output18.Bit << 18;
			result |= output19.Bit << 19;
			result |= output20.Bit << 20;
			result |= output21.Bit << 21;
			result |= output22.Bit << 22;
			result |= output23.Bit << 23;
			result |= output24.Bit << 24;
			result |= output25.Bit << 25;
			result |= output26.Bit << 26;
			result |= output27.Bit << 27;
			result |= output28.Bit << 28;
			result |= output29.Bit << 29;
			result |= output30.Bit << 30;
			result |= output31.Bit << 31;
			return result;
		}
		...
		public async override System.Threading.Tasks.Task Run()
		{
			...
			System.Diagnostics.Debug.Assert(overflow.Bit == 1, "Overflow bit");
