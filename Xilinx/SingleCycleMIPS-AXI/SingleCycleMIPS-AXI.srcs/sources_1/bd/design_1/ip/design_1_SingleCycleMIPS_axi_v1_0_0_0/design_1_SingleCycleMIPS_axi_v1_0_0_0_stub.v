...
//               /home/carljohnsen/vivado/SingleCycleMIPS-AXI/SingleCycleMIPS-AXI.srcs/sources_1/bd/design_1/ip/design_1_SingleCycleMIPS_axi_v1_0_0_0/design_1_SingleCycleMIPS_axi_v1_0_0_0_stub.v
...
module design_1_SingleCycleMIPS_axi_v1_0_0_0(cpu_clk, cpu_rst, control_aclk, 
  control_aresetn, control_awaddr, control_awprot, control_awvalid, control_awready, 
  control_wdata, control_wstrb, control_wvalid, control_wready, control_bresp, 
  control_bvalid, control_bready, control_araddr, control_arprot, control_arvalid, 
  control_arready, control_rdata, control_rresp, control_rvalid, control_rready, 
  instruction_aclk, instruction_aresetn, instruction_awaddr, instruction_awprot, 
  instruction_awvalid, instruction_awready, instruction_wdata, instruction_wstrb, 
  instruction_wvalid, instruction_wready, instruction_bresp, instruction_bvalid, 
  instruction_bready, instruction_araddr, instruction_arprot, instruction_arvalid, 
  instruction_arready, instruction_rdata, instruction_rresp, instruction_rvalid, 
  instruction_rready, memory_aclk, memory_aresetn, memory_awaddr, memory_awprot, 
  memory_awvalid, memory_awready, memory_wdata, memory_wstrb, memory_wvalid, memory_wready, 
  memory_bresp, memory_bvalid, memory_bready, memory_araddr, memory_arprot, memory_arvalid, 
  memory_arready, memory_rdata, memory_rresp, memory_rvalid, memory_rready)
/* synthesis syn_black_box black_box_pad_pin="cpu_clk,cpu_rst,control_aclk,control_aresetn,control_awaddr[3:0],control_awprot[2:0],control_awvalid,control_awready,control_wdata[31:0],control_wstrb[3:0],control_wvalid,control_wready,control_bresp[1:0],control_bvalid,control_bready,control_araddr[3:0],control_arprot[2:0],control_arvalid,control_arready,control_rdata[31:0],control_rresp[1:0],control_rvalid,control_rready,instruction_aclk,instruction_aresetn,instruction_awaddr[8:0],instruction_awprot[2:0],instruction_awvalid,instruction_awready,instruction_wdata[31:0],instruction_wstrb[3:0],instruction_wvalid,instruction_wready,instruction_bresp[1:0],instruction_bvalid,instruction_bready,instruction_araddr[8:0],instruction_arprot[2:0],instruction_arvalid,instruction_arready,instruction_rdata[31:0],instruction_rresp[1:0],instruction_rvalid,instruction_rready,memory_aclk,memory_aresetn,memory_awaddr[8:0],memory_awprot[2:0],memory_awvalid,memory_awready,memory_wdata[31:0],memory_wstrb[3:0],memory_wvalid,memory_wready,memory_bresp[1:0],memory_bvalid,memory_bready,memory_araddr[8:0],memory_arprot[2:0],memory_arvalid,memory_arready,memory_rdata[31:0],memory_rresp[1:0],memory_rvalid,memory_rready" */;
  input cpu_clk;
  input cpu_rst;
  input control_aclk;
