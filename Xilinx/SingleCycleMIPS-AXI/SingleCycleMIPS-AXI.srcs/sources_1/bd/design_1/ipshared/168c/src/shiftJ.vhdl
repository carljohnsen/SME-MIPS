...
entity shiftJ is
  port(
    -- Input bus JumpInstruction signals
    JumpInstruction_addr: in T_SYSTEM_UINT32;

    -- Output bus ShiftJump signals
    ShiftJump_addr: out T_SYSTEM_UINT32;
...
begin
	...
	begin
        ...
        if RST = '1' then
            ShiftJump_addr <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            ShiftJump_addr <= STD_LOGIC_VECTOR(shift_left(UNSIGNED(JumpInstruction_addr), 2));
