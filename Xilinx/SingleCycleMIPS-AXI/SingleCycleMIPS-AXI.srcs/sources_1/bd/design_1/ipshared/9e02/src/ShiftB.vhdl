...
entity ShiftB is
  port(
    ...
    -- Output bus ShiftBranch signals
    ShiftBranch_addr: out T_SYSTEM_UINT32;
...
begin
	...
	begin
        ...
        if RST = '1' then
            ShiftBranch_addr <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            ShiftBranch_addr <= STD_LOGIC_VECTOR(shift_left(UNSIGNED(SignExtOut_data), 2));
