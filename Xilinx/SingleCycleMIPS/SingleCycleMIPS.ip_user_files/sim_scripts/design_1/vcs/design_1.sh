...
#
# Generated by Vivado on Mon Jun 19 10:54:48 CEST 2017
...
# Design libraries
design_libs=(xil_defaultlib xpm lib_cdc_v1_0_2 proc_sys_reset_v5_0_11 xlconstant_v1_1_3)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../SingleCycleMIPS.srcs/sources_1/bd/design_1/ipshared/65a4" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_1/ip/design_1_SingleCycleMIPS_export_0_0/sim/design_1_SingleCycleMIPS_export_0_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SingleCycleMIPS.srcs/sources_1/bd/design_1/ipshared/65a4" \
  ...
  vhdlan -work lib_cdc_v1_0_2 $vhdlan_opts \
    "$ref_dir/../../../../SingleCycleMIPS.srcs/sources_1/bd/design_1/ipshared/52cb/hdl/lib_cdc_v1_0_rfs.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work proc_sys_reset_v5_0_11 $vhdlan_opts \
    "$ref_dir/../../../../SingleCycleMIPS.srcs/sources_1/bd/design_1/ipshared/5db7/hdl/proc_sys_reset_v5_0_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xlconstant_v1_1_3 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SingleCycleMIPS.srcs/sources_1/bd/design_1/ipshared/65a4" \
    "$ref_dir/../../../../SingleCycleMIPS.srcs/sources_1/bd/design_1/ipshared/45df/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/carljohnsen/vivado/SingleCycleMIPS/SingleCycleMIPS.cache/compile_simlib/vcs"
  fi
