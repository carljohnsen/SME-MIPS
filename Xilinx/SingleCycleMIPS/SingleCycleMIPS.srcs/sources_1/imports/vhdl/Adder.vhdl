...
entity Adder is
  port(
    -- Input bus ShiftBranch signals
    ShiftBranch_addr: in T_SYSTEM_UINT32;
    -- Input bus IncrementerOut signals
    IncrementerOut_address: in T_SYSTEM_UINT32;

    -- Output bus AdderOut signals
    AdderOut_address: out T_SYSTEM_UINT32;
...
begin
	...
	begin
        ...
        if RST = '1' then
            AdderOut_address <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            AdderOut_address <= STD_LOGIC_VECTOR(UNSIGNED(ShiftBranch_addr) + UNSIGNED(IncrementerOut_address));
