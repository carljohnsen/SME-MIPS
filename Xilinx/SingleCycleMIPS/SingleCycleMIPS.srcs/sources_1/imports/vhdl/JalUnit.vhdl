...
entity JalUnit is
  port(
    ...
    -- Input bus ALUResult signals
    ALUResult_data: in T_SYSTEM_UINT32;

    -- Output bus JALOut signals
    JALOut_val: out T_SYSTEM_UINT32;
...
architecture RTL of JalUnit is
...
begin
	...
	begin
        ...
        if RST = '1' then
            JALOut_val <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            if JAL_flg = '1' then
                ...
                local_var_0 := ALUResult_data;
            end if;
            JALOut_val <= local_var_0;
