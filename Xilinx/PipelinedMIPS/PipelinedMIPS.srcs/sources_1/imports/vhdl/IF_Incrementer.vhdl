...
entity IF_Incrementer is
  port(
    -- Input bus IF_Address signals
    IF_Address_address: in T_SYSTEM_UINT32;

    -- Output bus IF_IncrementerOut signals
    IF_IncrementerOut_address: out T_SYSTEM_UINT32;
...
architecture RTL of IF_Incrementer is
...
begin
	...
	begin
        ...
        if RST = '1' then
            IF_IncrementerOut_address <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            IF_IncrementerOut_address <= STD_LOGIC_VECTOR(UNSIGNED(IF_Address_address) + TO_UNSIGNED(4, 32));
