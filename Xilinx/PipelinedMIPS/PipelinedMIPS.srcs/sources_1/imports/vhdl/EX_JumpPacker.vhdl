...
entity EX_JumpPacker is
  port(
    -- Input bus EX_ShiftJump signals
    EX_ShiftJump_addr: in T_SYSTEM_UINT32;
    -- Input bus ID_Pipe_IncrementerOut signals
    ID_Pipe_IncrementerOut_addr: in T_SYSTEM_UINT32;

    -- Output bus EX_JumpPacked signals
    EX_JumpPacked_addr: out T_SYSTEM_UINT32;
...
architecture RTL of EX_JumpPacker is
...
begin
	...
	begin
        ...
        if RST = '1' then
            EX_JumpPacked_addr <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            EX_JumpPacked_addr <= (ID_Pipe_IncrementerOut_addr and STD_LOGIC_VECTOR'("11110000000000000000000000000000")) or EX_ShiftJump_addr;
