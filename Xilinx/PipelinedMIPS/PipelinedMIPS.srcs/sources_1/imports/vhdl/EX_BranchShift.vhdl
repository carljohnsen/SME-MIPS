...
entity EX_BranchShift is
  port(
    -- Input bus ID_Pipe_SignExtOut signals
    ID_Pipe_SignExtOut_data: in T_SYSTEM_UINT32;

    -- Output bus EX_ShiftBranch signals
    EX_ShiftBranch_addr: out T_SYSTEM_UINT32;
...
architecture RTL of EX_BranchShift is
...
begin
	...
	begin
        ...
        if RST = '1' then
            EX_ShiftBranch_addr <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            EX_ShiftBranch_addr <= STD_LOGIC_VECTOR(shift_left(UNSIGNED(ID_Pipe_SignExtOut_data), 2));
