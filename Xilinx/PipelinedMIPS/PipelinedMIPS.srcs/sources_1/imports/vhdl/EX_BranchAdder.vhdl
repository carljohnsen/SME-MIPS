...
entity EX_BranchAdder is
  port(
    -- Input bus EX_ShiftBranch signals
    EX_ShiftBranch_addr: in T_SYSTEM_UINT32;
    -- Input bus ID_Pipe_IncrementerOut signals
    ID_Pipe_IncrementerOut_addr: in T_SYSTEM_UINT32;

    -- Output bus EX_BranchAddress signals
    EX_BranchAddress_addr: out T_SYSTEM_UINT32;
...
architecture RTL of EX_BranchAdder is
...
begin
	...
	begin
        ...
        if RST = '1' then
            EX_BranchAddress_addr <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            EX_BranchAddress_addr <= STD_LOGIC_VECTOR(UNSIGNED(EX_ShiftBranch_addr) + UNSIGNED(ID_Pipe_IncrementerOut_addr));
