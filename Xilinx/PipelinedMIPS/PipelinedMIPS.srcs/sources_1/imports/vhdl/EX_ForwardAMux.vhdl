...
entity EX_ForwardAMux is
  port(
    -- Input bus ID_Pipe_OutputA signals
    ID_Pipe_OutputA_data: in T_SYSTEM_UINT32;
    ...
    -- Input bus EX_Forw_ForwardA signals
    EX_Forw_ForwardA_selection: in PipelinedMIPS_ForwardSelection;

    -- Output bus EX_ForwardA signals
    EX_ForwardA_data: out T_SYSTEM_UINT32;
...
architecture RTL of EX_ForwardAMux is
...
begin
    ...
    process(
        ...
        ID_Pipe_OutputA_data,
        EX_Pipe_JALOut_val,
        WB_WriteData_data,
        EX_Forw_ForwardA_selection,
        CLK,
        RST
    )
	...
	begin
        ...
        if RST = '1' then
            EX_ForwardA_data <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            case EX_Forw_ForwardA_selection is
                when PipelinedMIPS_ForwardSelection_original =>
                    EX_ForwardA_data <= ID_Pipe_OutputA_data;
                when PipelinedMIPS_ForwardSelection_mem =>
                    EX_ForwardA_data <= EX_Pipe_JALOut_val;
                when PipelinedMIPS_ForwardSelection_wb =>
                    EX_ForwardA_data <= WB_WriteData_data;
                when others =>
            end case;
