...
architecture RTL of IF_PCSrcMux is
...
begin
	...
	begin
        ...
        if RST = '1' then
            IF_PCIn_newAddress <= STD_LOGIC_VECTOR(TO_UNSIGNED(0, T_SYSTEM_UINT32'length));
            ...
            if JumpUnit_PCSrc_flg = '1' then
                local_var_0 := IF_MuxIn_addr;
            else
                local_var_0 := IF_IncrementerOut_address;
            end if;
            IF_PCIn_newAddress <= local_var_0;
