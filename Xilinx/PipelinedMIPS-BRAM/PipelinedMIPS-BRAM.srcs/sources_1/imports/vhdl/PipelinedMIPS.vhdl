...
entity PipelinedMIPS is
  port(
    ...
    -- Top-level bus IF_Pipe_Stall signals
    IF_Pipe_Stall_flg: inout T_SYSTEM_BOOL;

    -- Top-level bus IF_Pipe_Flush signals
    IF_Pipe_Flush_flg: inout T_SYSTEM_BOOL;
...
begin
    ...
    -- Entity  ID_Instruction_Mux signals
    ID_Instruction_Mux: entity work.ID_Instruction_Mux
    port map (
        -- Input bus IF_Pipe_Stall
        IF_Pipe_Stall_flg => IF_Pipe_Stall_flg,


        -- Input bus IF_Pipe_Flush
        IF_Pipe_Flush_flg => IF_Pipe_Flush_flg,
    ...
    port map (
        ...
        -- Output bus IF_Pipe_Stall
        IF_Pipe_Stall_flg => IF_Pipe_Stall_flg,


        -- Output bus IF_Pipe_Flush
        IF_Pipe_Flush_flg => IF_Pipe_Flush_flg,
