...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L util_vector_logic_v2_0_1 -L xil_defaultlib -L blk_mem_gen_v8_3_6 -L xlconstant_v1_1_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/carljohnsen/Xilinx/Vivado/2017.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
