...
#
# Generated by Vivado on Fri Aug 04 15:02:06 CEST 2017
...
# Design libraries
design_libs=(xil_defaultlib xpm util_vector_logic_v2_0_1 blk_mem_gen_v8_3_6 xlconstant_v1_1_3)
...
compile()
{
  ...
  vlogan -work util_vector_logic_v2_0_1 $vlogan_opts +v2k \
    "$ref_dir/../../../../PipelinedMIPS-BRAM.srcs/sources_1/bd/design_1/ipshared/6d4d/hdl/util_vector_logic_v2_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_1/ip/design_1_PipelinedMIPS_export_0_0/sim/design_1_PipelinedMIPS_export_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work blk_mem_gen_v8_3_6 $vlogan_opts +v2k \
    "$ref_dir/../../../../PipelinedMIPS-BRAM.srcs/sources_1/bd/design_1/ipshared/4158/simulation/blk_mem_gen_v8_3.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xlconstant_v1_1_3 $vlogan_opts +v2k \
    "$ref_dir/../../../../PipelinedMIPS-BRAM.srcs/sources_1/bd/design_1/ipshared/45df/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/carljohnsen/vivado/PipelinedMIPS-BRAM/PipelinedMIPS-BRAM.cache/compile_simlib/vcs"
  fi
