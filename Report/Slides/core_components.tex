...
\begin{frame}
    \begin{figure}
        \centering
        \scalebox{0.5}{
        % IDE! lav 32 bit solid, 16bit dashed og 8 er dotted alt under er
            % sparse dotted
            % efter at have prøvet: meh
            \begin{tikzpicture}
                ...
                \path[draw, ->, dotted] (splitspace.center) |- (reg.160);
                \path[draw, ->] (splitspace.center) |- (reg.200);
                \path[draw, ->] (splitspace.center) |- (jump.200);
                \path[draw, ->, densely dotted] (splitspace.center) |- (alucont.200);
